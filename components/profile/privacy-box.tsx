...
const PrivacyBox: React.FC = () => {
  ...
  return (
    <div className={`w-full flex flex-col px-8 py-6 rounded-lg transition-colors ease-out duration-150  ${focus ? 'bg-[#4F7FFF]' : null}`}>
      ...
      <form onSubmit={handleSubmit(onValid)} className="flex flex-col gap-3 mt-4">
        ...
        <Input name="새 비밀번호 확인" type="password" register={register('_password', { required: true })} focus={focus} required={true} />
